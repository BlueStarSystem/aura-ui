...
it('renders english locale day names by default', function () {
    $view = $this->blade('<x-aura::date-picker wire:model="test" />');
...
it('renders italian locale day names', function () {
    $view = $this->blade('<x-aura::date-picker locale="it" wire:model="test" />');
