...
@php
    ...
    $variantClasses = match($variant) {
        ...
        'success' => 'bg-aura-success-700 text-white border-transparent hover:bg-aura-success-800 focus-visible:shadow-[var(--aura-glow-success)]',
        'warning' => 'bg-aura-warning-500 text-aura-surface-900 border-transparent hover:bg-aura-warning-600 dark:bg-aura-warning-700 dark:text-white dark:hover:bg-aura-warning-800 focus-visible:shadow-[var(--aura-glow-warning)]',
    ...
    if ($outline) {
        $variantClasses = match($variant) {
            ...
            'secondary' => 'bg-transparent text-aura-surface-700 border-aura-surface-500 hover:bg-aura-surface-50 hover:border-aura-surface-600 focus-visible:shadow-[0_0_0_3px_rgba(100,116,139,0.2)]',
            'success' => 'bg-transparent text-aura-success-700 dark:text-aura-success-400 border-aura-success-600 hover:bg-aura-success-50 hover:border-aura-success-700 dark:hover:border-aura-success-500 focus-visible:shadow-[var(--aura-glow-success)]',
            'warning' => 'bg-transparent text-aura-warning-700 dark:text-aura-warning-400 border-aura-warning-600 hover:bg-aura-warning-50 hover:border-aura-warning-700 dark:hover:border-aura-warning-500 focus-visible:shadow-[var(--aura-glow-warning)]',
