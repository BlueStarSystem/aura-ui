...
>
    <button
        ...
        :aria-expanded="open"
    >
        <svg aria-hidden="true" focusable="false" class="aura-notification-center__bell" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
