<section id="dropdown" class="aura-playground-section">
    <h2 class="aura-section-title">Dropdown</h2>

    <h3 class="aura-section-subtitle">Default Dropdown</h3>
    <div class="aura-component-row">
        <div class="aura-dropdown" x-data="{ open: false }">
            <button class="aura-btn aura-btn-secondary" @click="open = !open">
                Azioni
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="6 9 12 15 18 9"/></svg>
            </button>

            <div class="aura-dropdown-menu"
                 x-show="open"
                ...
                <button class="aura-dropdown-item" @click="open = false">
                ...
                <div class="aura-dropdown-separator"></div>

                <button class="aura-dropdown-item aura-dropdown-item-danger" @click="open = false">
    ...
    <h3 class="aura-section-subtitle">With More Items</h3>
    <div class="aura-component-row">
        <div class="aura-dropdown" x-data="{ open: false }">
            <button class="aura-btn aura-btn-primary" @click="open = !open">
                Menu completo
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="6 9 12 15 18 9"/></svg>
            </button>
